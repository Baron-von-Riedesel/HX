...
;*  ========================================================================
;*
;*  Description:  This is the modified CSTRT386.ASM for HX MZ binaries.
;*                The most remarkable modification is the new include
;*                owmzhlp.inc, which defines public label "mainCRTStartup".
;*                and does some things specific to HX MZ binaries.
;*                "mainCRTStartup" is the label the HX MZ startup code
;*                jmppm32.obj will jump to once it has done its work.
;*
;*                code for other dos extenders has been removed in this file.
;*                the rational nonzerobased dos extender type is set for
;*                other code which wants/needs this to know for whatever
;*                reason.
;*
;*****************************************************************************
...
;
        ...
        mov     ah,XS_RATIONAL_NONZEROBASE ; - extender subtype
        ...
        mov     ds:__saved_DS,ds        ; save DS value
