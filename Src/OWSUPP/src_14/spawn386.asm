...
l_block struc
;l_envp  dp      ?                       ; pointer to environment (HX)
l_cmdline dq    ?                       ; pointer to command line
...
;        mov     dword ptr exeparm.l_envp,eax ; HX
;        mov     word ptr exeparm.l_envp+4,ds ; HX set segment
